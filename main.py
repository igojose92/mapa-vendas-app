...
def carregar_dados_e_gerar_html():
    try:
        ...
        for _, row in df.iterrows():
            ...
            content_html = f"""
                <div style='width: 280px; max-width: 82vw; max-height: 75vh; overflow-y: auto; font-family: sans-serif; line-height: 1.4; color: #ffffff; background: #2c3e50; padding: 0; border-radius: 10px; box-shadow: 0 8px 20px rgba(0,0,0,0.4); position: relative; user-select: none; -webkit-user-select: none;'>
                    <div style='background:{cor_hex}; color:#121212; padding: 12px; padding-right: 45px; border-radius: 10px 10px 0 0; font-weight: bold;'>
                        <div style='font-size:15px; word-wrap: break-word;'>{cliente}</div>
        ...
        <head>
            ...
            <style>
                ...
                *:focus {{ outline: none !important; }}
                ...
                #legend {{ position: absolute; bottom: 75px; right: 10px; background: var(--bg-primary); padding: 12px 15px; border-radius: 12px; box-shadow: 0 5px 15px rgba(0,0,0,0.2); z-index: 5; font-size: 12px; border: 1px solid var(--border-color); display: none; color: var(--text-color); }}
                .legend-row {{ display: flex; align-items: center; margin-bottom: 6px; font-weight: 600; gap: 8px; }}
                
                /* Pontinhos neon pequenininhos */
                .neon-dot {{
                    width: 6px;
                    height: 6px;
                    border-radius: 50%;
                ...
                .dot-comprou {{ color: #00FF66; background-color: #00FF66; }}
                .dot-nao-comprou {{ color: #FF2222; background-color: #FF2222; }}
                .dot-inativo {{ color: #AAAAAA; background-color: #AAAAAA; }}
                .dot-prospeccao {{ color: #00D2FF; background-color: #00D2FF; }}
        ...
        <body>
            ...
            <div id="filter-menu">
                ...
                <div class="filter-section">
                    ...
                    <div class="filter-body" id="body-status">
                        ...
                        <div class="chk-list">
                            <label class="chk-item"><input type="checkbox" class="chk-status" value="comprou_sim" checked onchange="applyFilters()"><span class="neon-dot dot-comprou"></span> <span style="color: #00FF66;">Comprou</span></label>
                            <label class="chk-item"><input type="checkbox" class="chk-status" value="comprou_nao" checked onchange="applyFilters()"><span class="neon-dot dot-nao-comprou"></span> <span style="color: #FF2222;">Não Comprou</span></label>
                            <label class="chk-item"><input type="checkbox" class="chk-status" value="inativo" checked onchange="applyFilters()"><span class="neon-dot dot-inativo"></span> <span style="color: #AAAAAA;">Inativo</span></label>
                            <label class="chk-item"><input type="checkbox" class="chk-status" value="prospeccao" checked onchange="applyFilters()"><span class="neon-dot dot-prospeccao"></span> <span style="color: #00D2FF;">Prospecção</span></label>
                        </div>
                    </div>
                </div>
            ...
            <div id="legend">
                <div class="legend-row"><span class="neon-dot dot-comprou"></span> <span style="color: #00FF66;">Comprou no Mês</span></div>
                <div class="legend-row"><span class="neon-dot dot-nao-comprou"></span> <span style="color: #FF2222;">Não Comprou no Mês</span></div>
                <div class="legend-row"><span class="neon-dot dot-prospeccao"></span> <span style="color: #00D2FF;">Prospecção</span></div>
                <div class="legend-row"><span class="neon-dot dot-inativo"></span> <span style="color: #AAAAAA;">Inativo</span></div>
            </div>
            ...
            <script>
                ...
                function fazerLogout() {{
                    localStorage.removeItem('mapa_user_email');
                    location.reload();
                }}
